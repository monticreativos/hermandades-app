...
class StoreHermanoRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'numero_hermano' => ['nullable', 'integer', 'min:1', 'unique:hermanos,numero_hermano'],
            'nombre' => ['required', 'string', 'max:120'],
            'apellidos' => ['required', 'string', 'max:180'],
            'dni' => ['required', 'string', 'max:12', 'unique:hermanos,dni', function ($attribute, $value, $fail) {
            ...
            'email' => ['nullable', 'email', 'max:150', 'unique:hermanos,email'],
